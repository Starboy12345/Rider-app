...
//Second box
  ...
  void findPlaces(String placeName) async
  {
    if (placeName.length>1){
      String  autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapkey&sessiontoken=1234567890&components=country:de";
...
class PredictionTile extends StatelessWidget {
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 8.0,),
                    Text(placePredictions.main_id,overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 16.0),),
                    SizedBox(height: 2.0,),
  ...
  void getPlaceAddressDetails( String placeId,context) async
  {
    ...
    showDialog(
        context: context,
        builder: (BuildContext context) => ProgressDialog(message: "Setting DroppOf,Please wait",));
    ...
    if (res["status"]=="OK")
    {
      Address address = Address(placeFormattedAddress:'', placeName:'', placeId:'', latitude: 0, longitude:0);
