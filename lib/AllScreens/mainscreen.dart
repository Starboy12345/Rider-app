...
class _MainScreenState extends State<MainScreen>{
          ...
          child: ListView(
            children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Profile Name",style: TextStyle(fontSize: 16.0,fontFamily: "BrandBold"),),
                          SizedBox(height: 6.0,),
                          Text("Visit Profile"),
                        ],
                      ),
              ...
              ListTile(
                ...
                title: Text("View Profile Button", style: TextStyle(fontSize: 15.0),),
              ),
              ListTile(
  ...
  Future <void> getPlaceDirection() async{
    ...
    showDialog(context: context, builder: (BuildContext context) => ProgressDialog(message: "Setting Dropoff,..... ",)
    );

    var details = await AssistantMethods.obtainDirectionDetails(pickUpLapLng, dropOffLapLng);
