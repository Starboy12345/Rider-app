...
class LoginScreen extends StatelessWidget {
                ...
                children: [
                  ...
                  RaisedButton(
                    ...
                    onPressed: ()
                    {
                      ...
                      {
                        displayToastMessage("Password Field cannot be empty.Please Fill ", context);
                      }else{
  ...
  final FirebaseAuth _firebaseAuth= FirebaseAuth.instance;
   void loginAndAuthenticateUser ( BuildContext context) async
   {
     ...
     if (firebaseUser != null)// user creted
         {
       userRef.child(firebaseUser.uid).once().then((DataSnapshot snap){
         if (snap.value != null)
           {
             Navigator.pushNamedAndRemoveUntil(context, MainScreen.idScreen, (route) => false);
             displayToastMessage("Welcome,You are already logged in  ", context);
           }
         else{
           Navigator.pop(context);
     ...
     else
     {
       ...
       displayToastMessage(" An Error occurred During Sign in.Sorry !!!!!  ", context);
